...
O desenvolvimento e a proposta pedagógica deste jogo são fundamentados no artigo científico publicado na **RENOTE (Revista Novas Tecnologias na Educação - CINTED/UFRGS)**:

* **Título:** *Gamificação no Ensino Superior em Ciência da Computação: Uma Revisão Sistemática da Literatura*
* **Autores:** Felipe Augusto Feichas, Rodrigo Duarte Seabra, Adler Diniz de Souza (UNIFEI)
* **DOI:** [10.22456/1679-1916.118534](https://doi.org/10.22456/1679-1916.118534)

### Principais Achados do Artigo Aplicados ao Jogo:

1. **Aumento do Engajamento:** A introdução de elementos de jogos (como níveis, pontuação e conquistas) aumenta drasticamente o envolvimento e interesse dos estudantes com o conteúdo acadêmico.
